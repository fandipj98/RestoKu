...
class KeranjangController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $query = $this->modelsManager->createQuery("SELECT * FROM Keranjang x WHERE x.id_user = $id_user AND x.status_keranjang = 0");
    ...
    public function createAction()
    {
        if($this->request->isPost()){
            ...
            if($menu->tersedia > 0){
                $query = $this->modelsManager->createQuery("SELECT * FROM Keranjang x WHERE x.id_user = $id_user AND x.id_menu = $id_menu AND x.status_keranjang = 0");
